    ...
    <el-row style="margin-top: 10px;">
      <el-col :span="12">
        <div class="grid-content bg-purple ">
          ...
          <span style="font-size: 18px">{{sn}}</span>
        </div>
      </el-col>
        ...
        <el-form :model="form" >
          <el-form-item  >
            ...
            <el-select v-model="region" placeholder="请选择商品名">
              ...
              <el-option v-for="good in goodslist" :label="good.name" :value="good.name">
    ...
    methods: {
      getOrder(){
        axios.post('orderDetail/look/'+ this.$route.query.no ).then(res =>{
          ...
          this.sn = res.no,
            this.value1 = res.arrivalDt,
            this.tableData = res.orderDetailVoList
          this.ownername = res.ownerName,
          this.supcode = res.supplierCode,
          this.supname = res.supplierName,
            this.id = res.id
            this.getAll()
      ...
      getGoods(){
        ...
        axios.post('/product/page', parms).then(res =>{
          console.log(res.datas.length == 0)
      ...
      link(){
        ...
        let parms = {
          ...
          "arrivalDt": date,
          "no": this.sn,
          "orderDetailDeleteIdList": [],
          "orderDetailUpdateList":  this.tableData ,
        ...
        console.log(parms)
        axios.post('order/update',parms).then(res =>{
      ...
      addGoods(){
        ...
        if (this.price.code){
          ...
          a.productCode = this.price.productCode
          a.productName = this.price.productName
        }
